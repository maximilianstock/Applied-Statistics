...
plot_election_polls <- ggplot(german_election_polls, aes(x = end_date))+
  ...
  geom_line(aes(y=rollmean(union, 14, na.pad=TRUE)), color = "black")+
  ...
  labs(x="Poll Date", y="Voting Percentage", title = "German Elections", subtitle = "Change in estimated voting during 2021")
  theme_bw()
